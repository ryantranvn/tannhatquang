...
--
-- Host: localhost:3306
-- Generation Time: Oct 18, 2017 at 11:30 PM
...
(276, '7b20fc81df1e8598c0be3cf4f0163727', 1507833797, '::1', 'QBSBB'),
(277, '1e684bd92bc1a6737f6b60483f22f028', 1507834215, '::1', 'DTDSL'),
(278, '00f3db4286be294db51941ffb059cf6a', 1508343587, '::1', 'ULWWF');
...
INSERT INTO `customer` (`id`, `username`, `password`, `fullname`, `email`, `phone`, `created_datetime`, `updated_datetime`, `del_flg`) VALUES
(1, NULL, NULL, 'a Hải', '', '0909123456', '2017-10-18 22:36:42', '2017-10-18 22:36:42', 0);
...
INSERT INTO `district` (`id`, `name`, `type`, `location`, `id_province`) VALUES
...
INSERT INTO `news` (`id`, `post_id`, `title`, `url`, `thumbnail`, `description`, `detail`, `order`) VALUES
...
INSERT INTO `order` (`id`, `customer_id`, `customer_address_id`, `note`, `total`, `status`, `created_datetime`, `updated_datetime`) VALUES
(1, 1, NULL, '', 165000, 0, '2017-10-18 22:36:42', '2017-10-18 22:36:42');
...
INSERT INTO `order_detail` (`id`, `order_id`, `post_id`, `quantity`, `price`, `price_sale`, `price_sale_percent`, `sub_total`, `created_datetime`, `updated_datetime`, `del_flg`) VALUES
...
INSERT INTO `post` (`id`, `category_id`, `category_name`, `type`, `status`, `created_datetime`, `created_by`, `updated_datetime`, `updated_by`, `del_flg`, `hot_flg`) VALUES
...
INSERT INTO `post_picture` (`id`, `post_id`, `url`) VALUES
...
--
ALTER TABLE `captcha`
  MODIFY `captcha_id` bigint(13) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=279;
--
