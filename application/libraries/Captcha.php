...
*/
    ...
    var $font_name = 'verdanab.ttf'; // test.ttf
    var $font_path = './fonts'; // PATH_TTF
    var $fonts = array(); // Collect fonts name from fonts folder
    var $font_size = 15; // CODE_FONT_SIZE

    var $char_set = "ABCDEFGHJKLMNPQRSTUVWXYZ"; //"ABCDEFGHJKLMNPQRSTUVWXYZ2345689"; //CODE_ALLOWED_CHARS
    ...
    //var $bg_color = 'url(./captcha/bg.png) repeat';
