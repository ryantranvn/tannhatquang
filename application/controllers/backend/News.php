...
// Add
    public function add()
    {
        ...
        // get news category list
            $this->data['arrNews'] = $this->Base_model->getDB('db', 'category', NULL, array('parent_id' => $this->idCategory), NULL, array('id','order','name','name_en'), array('asc','asc','asc','asc'));
        // create form
    ...
    public function add_db()
    {
        ...
        // insert database
            $postAdd = array('title' => $title,
                                 ...
                                 'content' => $this->input->post('contentNews'),
                                 'content_en' => $this->input->post('contentNewsEN'),
