														...
														<div class="row">
															<div class="col-sm-12 col-md-12 col-lg-12">
																...
																<div id="categoryWrapper">
																	...
																	<a class="category btn btn-default" data-save="service-introduction-mobile">Service-Introduction</a>
																	<a class="category btn btn-default" data-save="service-service-mobile">Service-Service</a>
																	<a class="category btn btn-default" data-save="service-certification-mobile">Service-Certification</a>
																	<a class="category btn btn-default" data-save="booking-mobile">Booking</a>
																	<a class="category btn btn-default" data-save="gallery-beforeafter-mobile">Gallery-BeforeAfter</a>
																	<a class="category btn btn-default" data-save="gallery-event-mobile">Gallery-Event</a>
																	<a class="category btn btn-default" data-save="news-mobile">News</a>
																	<a class="category btn btn-default" data-save="news-detail-mobile">News-Detail</a>
																	<a class="category btn btn-default" data-save="contact-mobile">Contact</a>
																</div>
											...
											<div class="col-sm-12 col-md-6 col-lg-6">
												<fieldset>
													<div class="form-group">
														...
														<div class="thumbnailWrapper" style="margin-top: 10px">
															<?php if ($banner['bannerServiceIntroductionEN']['url'] != "") { ?>
											...
											<div class="col-sm-12 col-md-6 col-lg-6">
												<fieldset>
													<div class="form-group">
														...
														<div class="thumbnailWrapper" style="margin-top: 10px">
															<?php if ($banner['bannerServiceCertificationVN']['url'] != "") { ?>
											...
											<div class="col-sm-12 col-md-6 col-lg-6">
												<fieldset>
													<div class="form-group">
														...
														<div class="thumbnailWrapper" style="margin-top: 10px">
															<?php if ($banner['bannerServiceCertificationEN']['url'] != "") { ?>
											...
											<div class="col-sm-12 col-md-6 col-lg-6">
												<fieldset>
													<div class="form-group">
														...
														<div class="thumbnailWrapper" style="margin-top: 10px">
															<?php if ($banner['bannerBookingVN']['url'] != "") { ?>
											...
											<div class="col-sm-12 col-md-6 col-lg-6">
												<fieldset>
													<div class="form-group">
														...
														<div class="thumbnailWrapper" style="margin-top: 10px">
															<?php if ($banner['bannerBookingEN']['url'] != "") { ?>
											...
											<div class="col-sm-12 col-md-6 col-lg-6">
												<fieldset>
													<div class="form-group">
														...
														<div class="thumbnailWrapper" style="margin-top: 10px">
															<?php if ($banner['bannerGalleryBeforeafterVN']['url'] != "") { ?>
											...
											<div class="col-sm-12 col-md-6 col-lg-6">
												<fieldset>
													<div class="form-group">
														...
														<div class="thumbnailWrapper" style="margin-top: 10px">
															<?php if ($banner['bannerGalleryBeforeafterEN']['url'] != "") { ?>
											...
											<div class="col-sm-12 col-md-6 col-lg-6">
												<fieldset>
													<div class="form-group">
														...
														<div class="thumbnailWrapper" style="margin-top: 10px">
															<?php if ($banner['bannerGalleryEventVN']['url'] != "") { ?>
											...
											<div class="col-sm-12 col-md-6 col-lg-6">
												<fieldset>
													<div class="form-group">
														...
														<div class="thumbnailWrapper" style="margin-top: 10px">
															<?php if ($banner['bannerGalleryEventEN']['url'] != "") { ?>
											...
											<div class="col-sm-12 col-md-6 col-lg-6">
												<fieldset>
													<div class="form-group">
														...
														<div class="thumbnailWrapper" style="margin-top: 10px">
															<?php if ($banner['bannerNewsVN']['url'] != "") { ?>
											...
											<div class="col-sm-12 col-md-6 col-lg-6">
												<fieldset>
													<div class="form-group">
														...
														<div class="thumbnailWrapper" style="margin-top: 10px">
															<?php if ($banner['bannerNewsEN']['url'] != "") { ?>
											...
											<div class="col-sm-12 col-md-6 col-lg-6">
												<fieldset>
													<div class="form-group">
														...
														<div class="thumbnailWrapper" style="margin-top: 10px">
															<?php if ($banner['bannerNewsDetailVN']['url'] != "") { ?>
											...
											<div class="col-sm-12 col-md-6 col-lg-6">
												<fieldset>
													<div class="form-group">
														...
														<div class="thumbnailWrapper" style="margin-top: 10px">
															<?php if ($banner['bannerNewsDetailEN']['url'] != "") { ?>
											...
											<div class="col-sm-12 col-md-6 col-lg-6">
												<fieldset>
													<div class="form-group">
														...
														<div class="thumbnailWrapper" style="margin-top: 10px">
															<?php if ($banner['bannerContactVN']['url'] != "") { ?>
											...
											<div class="col-sm-12 col-md-6 col-lg-6">
												<fieldset>
													<div class="form-group">
														...
														<div class="thumbnailWrapper" style="margin-top: 10px">
															<?php if ($banner['bannerContactEN']['url'] != "") { ?>
