															...
															<div class="col-sm-12 col-md-12 col-lg-12">
																...
																<div id="categoryWrapper">
																	<? foreach ($arrNews as $key => $news) { ?>
																		<a class="category btn btn-default <? if ($news['id']==$editPost['parent_id']) { echo "btn-success"; } ?>" data-save="<?=$news['id']?>"><?=$news['name']?></a>
																	<? } ?>
																</div>
												...
												<fieldset>
													<div class="form-group">
														<div class="col-sm-12 col-md-12 col-lg-12">
															...
															<textarea name="contentNews" class="form-control resizeVer"><?=$editPost['content']?></textarea>
														</div>
													</div>
												</fieldset>
											</div>
												...
												<fieldset>
													<div class="form-group">
														<div class="col-sm-12 col-md-12 col-lg-12">
															...
															<textarea name="contentNewsEN" class="form-control resizeVer"><?=$editPost['content_en']?></textarea>
														</div>
													</div>
												</fieldset>
											</div>
