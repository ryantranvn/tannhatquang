...
<html lang="en-us" id="extr-page">
	...
	<body class="animated fadeInDown">
		...
		<header id="header">
			...
			<img id="logoDev" src="<?php echo assetsUrl('common','images','logo-dev.png'); ?>" class="pull-right display-image" alt="" style="max-height: 90%; margin: 0;">
			<!--
					...
					<div class="col-xs-12 col-sm-12 col-md-7 col-lg-8 hidden-xs hidden-sm">
						...
						<div class="hero">
							...
							<div class="pull-left login-desc-box-l">
								<h4 class="paragraph-header">Không phải admin, đi chỗ khác chơi...</h4>
